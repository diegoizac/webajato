...
<div class="form-group">
    ...
    <div class="col-sm-10">
	<select class="form-control" id="tipo_id" name="endereco[tipo_id]">
	<option value="01" >Endereco Principal</option>
	<option value="02" >Endereco Cobranca</option>
	</select>
    </div>
</div>
    ...
    $(function(){
        ...
        $('#btnConsultarCorreios').getCep({
            ...
            onSuccess: function(endereco){
                ...
                $('#cidade_id').attr('default', decodeEntities(endereco.localidade));
